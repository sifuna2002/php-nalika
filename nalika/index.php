        ...
        <nav id="sidebar" class="">
            ...
            <div class="nalika-profile">
                <div class="profile-dtl">
                    ...
                    <h2><?php
                    echo $c;
                    ?><span class="min-dtn">Das</span></h2>
                    <form method="post">
                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="File Manager" href="file-manager.html"><span class="mini-sub-pro">File
                                            Manager</span></a></li>
                        ...
                        <li>
                            <a class="has-arrow" href="mailbox.html" aria-expanded="false"><i
                                    class="icon nalika-forms icon-wrap"></i> <span class="mini-click-non">Forms
                                    Elements</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
